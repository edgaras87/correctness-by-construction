...
**It ships in the kit** (HANDBOOK ADR-0030, closing HANDBOOK ADR-0023's
deferral). Its project-side reader is the injecting agent running §8 —
and the keeper of a project's copies, who needs §6 and §7 the moment a
convention arrives. Before §8 existed that role did not, and shipping
was dead weight (HANDBOOK ADR-0023). A project born earlier holds
conventions this one governs without holding it, and takes it by §8 like
any other.
