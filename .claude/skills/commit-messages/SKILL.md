...
every commit at a prompt the human answers (HANDBOOK ADR-0035) — the kit
shipped one and withdrew it, unrun. The subject limit is enforced nowhere
either, which is what 15 of the first 20 commits looked like.
