<!-- BASELINE — held for comparison, blind to newborns. The shipped
     CLAUDE.md template frozen whole 2026-09-06 (at e44dae9),
     before the past-run harvest was stripped from the live file:
     its method half — the stance bullets, the pre-framing guard —
     descends from walk-1's derivation and the withdrawn startup
     snippet (the ADR-0014 merge), text earned under a different
