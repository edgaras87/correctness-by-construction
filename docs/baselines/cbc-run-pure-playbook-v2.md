<!-- BASELINE — held for comparison, blind to newborns. The pure
     variant frozen whole at v2, 2026-09-06 (at ea1f6b2), before
     the gates experiment stripped its middle steps to
     derive-at-opening form (v3). Held for the per-step reading:
     the run's derived gates against these, compared at each
